...
"""
vectors = pickle.load(open("C:/Users/HP/Flood based image retreival system/static/vectors.pkl","rb"))
paths = pickle.load(open("C:/Users/HP/Flood based image retreival system/static/paths.pkl","rb"))
...
def upload():
    clearUpload('C:/Users/HP/Flood based image retreival system/uploads')
...
def query():
    ...
    for path in nearest_image:
        ...
        print("Temp")
        print(tmp)
        temp1 = "./static/dataset/img/"
        full_path = temp1+tmp[-1]
        # version = f'?v={int(round(time.time() * 1000))}'
        # full_path = os.path.join('C:/Users', tmp[2], tmp[3]) + version
        # print(full_path)
